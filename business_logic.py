...
conn = sqlite3.connect('dataset_inquilinos.db')

# Leemos los datros de la tabla de SQLite
df = pd.read_sql_query('SELECT * FROM inquilinos', conn, index_col='id_inquilino')
